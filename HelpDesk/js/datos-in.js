			...
			success : function(res){
				...
				$.each(res, function(key,value){
					...
					if(value['id_estado'] == 3){
						template += '<td>'+
										'<span class="btn btn-info">On wait</span>' +
									'</td>'  ; 
					}
					if(value['id_estado'] == 4){
						template += '<td>'+
										'<span class="btn btn-primary">Canceled</span>' +
									'</td>'  ; 
					}
					if(value['id_estado'] == 2){
						template += '<td>'+
									'<a href="#" class="btn btn-primary"><i class="fa fa-trash-o"></i> Delete</a>'+
								'</td>'  + 
							'</tr>';						
					}
					else{
						template += '<td>'+
									...
									id_restrinccion_red +');"><i class="fa fa-trash-o"></i> Delete</a>'+
								'</td>'  + 
							'</tr>';
					}
                });
				...
				$.each(res, function(key,value){
					...
					if(value['id_estado'] == 2){
						...
						template += '<td>'+
									...
									id_solicitud_software +');"><i class="fa fa-trash-o"></i> Delete</a>'+
								'</td>'  + 
							'</tr>';
					}
                });
				...
				$.each(res, function(key,value){
					...
					if(value['id_estado'] == 2){
						...
						template += '<td>'+
									...
									id_instalacion_software +');"><i class="fa fa-trash-o"></i> Delete</a>'+
								'</td>'  + 
							'</tr>';
					}
                });
				...
				$.each(res, function(key,value){
					...
					if(value['id_estado'] == 2){
						...
						template += '<td>'+
									...
									id_danios_equipo +');"><i class="fa fa-trash-o"></i> Delete</a>'+
								'</td>'  + 
							'</tr>';
					}
                });
				...
				$.each(res, function(key,value){
					...
					if(value['id_estado'] == 2){
						...
						template += '<td>'+
									...
									id_solicitud_equipo +');"><i class="fa fa-trash-o"></i> Delete</a>'+
								'</td>'  + 
							'</tr>';
					}
                });
				...
				$.each(res, function(key,value){
					...
					if(value['id_estado'] == 2){
						...
						template += '<td>'+
									...
									id_cuenta +');"><i class="fa fa-trash-o"></i> Delete</a>'+
								'</td>'  + 
							'</tr>';
					}
                });
				...
				$.each(res, function(key,value){
					...
					if(value['id_estado'] == 2){
						...
						template += '<td>'+
									...
									id_restablecer +');"><i class="fa fa-trash-o"></i> Delete</a>'+
								'</td>'  + 
							'</tr>';
					}
                });
				...
				$.each(res, function(key,value){
					...
					if(value['id_estado'] == 2){
						...
						template += '<td>'+
									...
									id_plataformas_virtuales +');"><i class="fa fa-trash-o"></i> Delete</a>'+
								'</td>'  + 
							'</tr>';
					}
                });
